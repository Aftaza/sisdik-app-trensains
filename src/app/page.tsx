...
function LoginContent() {
    ...
    // We'll handle error messages through props instead of using useSearchParams directly
    // This avoids the suspense boundary issue during SSR
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <div className="relative">
                                        ...
                                        <Button // ✅ PERBAIKAN: Gunakan komponen Button dari shadcn/ui
                                            type="button" // ✅ PERBAIKAN PENTING: Mencegah form ter-submit
                                            variant="ghost"
                                            size="icon"
...
export default function LoginPage() {
    return (
        <Suspense fallback={(<div className="flex justify-center items-center h-screen"><Loader2 className="h-6 w-6 animate-spin text-gray-700 dark:text-slate-100" /></div>)}>
            <LoginContent />
        </Suspense>
    );
}